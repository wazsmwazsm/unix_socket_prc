...
int main() {
    ...
    getsockopt(sock, 0xffff, 0x1001, (char*)&optSndVal, &optLen);
    getsockopt(sock, 0xffff, 0x1002, (char*)&optRcvVal, &optLen);
    printf("Send Buffer length: %d, Recv buffer length:%d\n", optSndVal, optRcvVal);


    unsigned newOptSndVal = 1024;
    setsockopt(sock, 0xffff, 0x1002, (char*)&newOptSndVal, optLen);

    getsockopt(sock, 0xffff, 0x1002, (char*)&optSndVal, &optLen);
    printf("Send Buffer length: %d, Recv buffer length:%d\n", optSndVal, optRcvVal);
